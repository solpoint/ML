...
#Remove flights without NA air times
...
#Conduct an ANOVA test at 5% significance
...
#Again, the relationship between the delays and the distance is weak, with a corre. coeffecient of -0.04.   
...
#There is a fairly moderate relationship between the age of the plane and the delay as given by r, 0.45
